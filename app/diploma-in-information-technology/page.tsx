                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Diploma in <span className="text-[#EE4A62]">Information Technology</span>
                            </h1>

                            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                                Elevate your tech career with our Diploma in Information Technology at Edusphere, designed to equip you with cutting-edge skills in a flexible, online environment. Join us and master the digital world from anywhere!
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Cutting-Edge</div>
                                        <div className="text-sm text-gray-500">AI & Blockchain focus</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Cybersecurity</div>
                                        <div className="text-sm text-gray-500">Industry-ready skills</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'Diploma in Information Technology' will be awarded by Edusphere College of Management and Technology Pte Ltd
                            </p>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <div className="space-y-2 text-sm text-gray-700 max-w-xl">
                                ...
                                <div className="flex items-start justify-between gap-4 font-semibold text-base">
                                    <span>Total Fees</span>
                                    <span className="font-bold text-gray-900">:&nbsp;&nbsp;S$ 2400.00</span>
                                </div>
                                <div className="text-xs text-gray-500 italic mt-2">(excluding registration fee)</div>
                            </div>
                        </div>

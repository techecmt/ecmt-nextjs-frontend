...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		url: "https://edusphere.edu.sg/diploma-in-hospitality-management-e-learning",
		siteName: "Edusphere College of Management and Technology",
		locale: "en_SG",
		type: "website",
	},
	alternates: {
		canonical: "https://edusphere.edu.sg/diploma-in-hospitality-management-e-learning",
	},
};
					...
					<div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
						...
						<div className="space-y-6">
							...
							<p className="text-lg md:text-xl text-gray-600 leading-relaxed">
								Embark on a global journey connecting with diverse cultures and the vibrant tourism and hospitality industry. Gain adaptable, resourceful, and applied skills across core business and specialised areas to thrive in hotel and tourism roles.
							</p>
							...
							<div className="flex flex-wrap gap-6 pt-4">
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Global-Facing</div>
										<div className="text-sm text-gray-500">Tourism & hospitality skills</div>
									</div>
								</div>
								<div className="flex items-center gap-3">
						...
						<div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
							<Image
								src="/homepage/dhtm-el.webp"
								alt="Diploma in Hotel and Tourism Management E-Learning"
								fill
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					...
					<div className="mb-8">
						<p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
							This course grooms future leaders for the hospitality and tourism industry. Build adaptability, resourcefulness, and knowledge across core business subjects and specialised areas like Room Division Management, F&B Services, Waste Management for Hotels and Restaurants, plus entrepreneurial skills to launch or grow your career.
						</p>
					</div>
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<ul className="space-y-3 text-gray-700 text-sm">
								<li className="flex items-start gap-3">
									...
									<span>Minimum 3 GCE 'O' level – C6 or Pass in International Secondary including English</span>
								</li>
								<li className="flex items-start gap-3">
									<svg className="w-5 h-5 text-[#EE4A62] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<p className="text-gray-700 text-sm">E-learning</p>
						</div>
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<p className="text-gray-700 text-sm">'Diploma in Hotel and Tourism Management (E-Learning)' will be awarded by Edusphere College of Management and Technology Pte Ltd.</p>
						</div>

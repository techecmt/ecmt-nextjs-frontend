...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://edusphere.edu.sg/advanced-diploma-in-nursing-care-assistant-e-learning",
        siteName: "Edusphere College of Management and Technology",
        locale: "en_SG",
        type: "website",
    },
    alternates: {
        canonical: "https://edusphere.edu.sg/advanced-diploma-in-nursing-care-assistant-e-learning",
    },
};
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Advanced Diploma in <span className="text-[#EE4A62]">Nursing Care Assistant</span><br />
                                <span className="text-[#1AB69D]">(E-Learning)</span>
                            </h1>

                            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                                Advance your career in healthcare with our Advanced Diploma in Nursing Care Assistant (E-Learning), designed to enhance your skills and knowledge for providing exceptional patient care. Gain the expertise needed to excel in the nursing field from the comfort of your home.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Healthcare Focus</div>
                                        <div className="text-sm text-gray-500">Patient care excellence</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                        ...
                        <div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
                            <Image
                                src="/homepage/adnca-el.jpg"
                                alt="Advanced Diploma in Nursing Care Assistant E-Learning"
                                fill
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
                            ADVANCED DIPLOMA IN NURSING CARE ASSISTANT (E-LEARNING) is designed to provide students with a strong foundation and technical knowledge in nursing care assistant/aide skills. During this course, students will learn about topics such as Fundamentals of Nursing care, Community Diseases, Medical Terminology etc. Nursing care assistants are also known as nurse aides, they will be equipped with Ward management and Transcription skill to run the medical care department efficiently. They work alongside or under the supervision of qualified nurses (RNs) and Doctors. Nursing Care Assistant professionals possess a good employability opportunity in sectors such as Nursing Homes, Medical Writing, Administration, Health Care Centres, Educational institutes, etc.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'ADVANCED DIPLOMA IN NURSING CARE ASSISTANT (E-LEARNING)' will be awarded by Edusphere College of Management and Technology Pte Ltd.
                            </p>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200 text-gray-900">
                                    {[
                                        { code: "ADNCA01", title: "Principles of Nursing Aide", hours: 24 },
                                        { code: "ADNCA02", title: "Medical Terminology", hours: 24 },
                                        { code: "ADNCA03", title: "Basic Human Sciences- Anatomy, Physiology, Pathology", hours: 24 },
                                        { code: "ADNCA04", title: "Ward Management", hours: 24 },
                                        { code: "ADNCA05", title: "Community Health Nursing", hours: 24 },
                                        { code: "ADNCA06", title: "Principle of Medical Transcription", hours: 24 },
                                    ].map((module, idx) => (

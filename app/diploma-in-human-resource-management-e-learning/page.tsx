...
export const metadata: Metadata = {
    title: "Diploma in Human Resource Management (E-Learning) | Edusphere Singapore",
    description: "Online Diploma in HR Management at Edusphere College. 100% e-learning, 8-month course covering HR principles, Employment Law, Training & Development. Flexible online learning.",
    keywords: "HR diploma online, human resource management e-learning, online HR course singapore, human resources certification online",
    openGraph: {
        title: "Diploma in Human Resource Management (E-Learning) | Edusphere Singapore",
        description: "100% online HR diploma covering HRM principles, Psychology, Employment Law & Training. Flexible e-learning, 8 months.",
        url: "https://www.edusphere.edu.sg/diploma-in-human-resource-management-e-learning",
        siteName: "Edusphere College of Management and Technology",
        locale: "en_SG",
        type: "website",
    },
    alternates: {
        canonical: "https://www.edusphere.edu.sg/diploma-in-human-resource-management-e-learning",
    },
};

export default function DiplomaInHumanResourceManagementELearning() {
    const courseSchema = {
        "@context": "https://schema.org",
        "@type": "Course",
        "name": "Diploma in Human Resource Management (E-Learning)",
        "description": "Comprehensive online HR management diploma covering principles of HRM, organizational psychology, employment law, and training & development.",
        "provider": {
        ...
        "educationalCredentialAwarded": "Diploma in Human Resource Management",
        "timeToComplete": "P8M",
        "totalTime": "PT144H",
        "courseMode": "Online",
        "inLanguage": "en",
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Diploma in <span className="text-[#EE4A62]">Human Resource Management</span><br />
                                <span className="text-[#1AB69D]">(E-Learning)</span>
                            </h1>

                            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                                Diploma in Human Resource Management is designed to provide opportunities for adult learners who are either currently holding HR jobs or considering a future HR career progression or option.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">HR Focused</div>
                                        <div className="text-sm text-gray-500">Career progression ready</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-500">Study anywhere, anytime</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
                            <Image
                                src="/homepage/hrm-elearning.webp"
                                alt="Diploma in Human Resource Management E-Learning"
                                fill
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
                            Diploma in Human Resource Management (E-Learning) is designed to provide opportunities for adult learners who are either currently holding HR jobs or considering a future HR career progression or option. The modules are designed to enable participants to acquire sufficient breadth of knowledge, deeper insights of human capital management and greater understanding of local legislation to play a key role in organisation development and contributing to business growth.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 flex flex-col justify-between">
                            <div className="flex flex-col h-full justify-between">
                                ...
                                <div className="flex flex-col justify-evenly flex-1 space-y-3 text-gray-700 text-sm">
                                    <ul className="list-disc list-inside space-y-2">
                                        <li>
                                            <span className="font-semibold uppercase">Weekend:</span>
                                            <span className="ml-2">
                                                (4 Hours per week) Sat or Sunday (10AM to 2PM) or (2PM to 6PM) or (6PM to 10PM)
                                            </span>
                                        </li>
                                        <li>
                                            <span className="font-semibold uppercase">Weekday:</span>
                                            <span className="ml-2">
                                                Wed &amp; Fri (7PM to 9PM)
                                            </span>
                                        </li>
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'Diploma in Human Resource Management (E-Learning)' will be awarded by Edusphere College of Management and Technology Pte Ltd.
                            </p>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200 text-gray-900">
                                    {[
                                        { code: "DHRM01", title: "Principles of Human Resource Management", hours: 24 },
                                        { code: "DHRM02", title: "Effective Business Communication", hours: 24 },
                                        { code: "DHRM03", title: "Accounting for Managers", hours: 24 },
                                        { code: "DHRM04", title: "Organisation Psychology", hours: 24 },
                                        { code: "DHRM05", title: "Employment Law & Contracts", hours: 24 },
                                        { code: "DHRM06", title: "Training & Development", hours: 24 },
                                    ].map((module, idx) => (

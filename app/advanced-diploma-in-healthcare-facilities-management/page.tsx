                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <span className="inline-flex items-center px-3 py-1 rounded-full bg-[#EE4A62]/10 text-[#EE4A62] text-xs font-semibold">
                                    S$600 Discount Available
                                </span>
                            </div>

                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Advanced Diploma in <span className="text-[#EE4A62]">Healthcare Facilities Management</span>
                            </h1>

                            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                                This course is developed for those who are currently working or intend to work in the Facilities Management or Facilities Maintenance in healthcare sector.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">IoT-Enabled</div>
                                        <div className="text-sm text-gray-500">Smart healthcare systems</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Predictive</div>
                                        <div className="text-sm text-gray-500">Maintenance solutions</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
                            <Image
                                src="/homepage/adhfm.webp"
                                alt="Advanced Diploma in Healthcare Facilities Management"
                                fill
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
                            This course is developed for those who are currently working or intend to work in the Facilities Management or Facilities Maintenance in healthcare sector. The existing system needs to adapt or update to the "New Norm" of living with endemic. This course extensively covers the maintenance and operations requirements for advanced health care facilities including emergency management, energy conservation, maintenance management, managing breakdowns, engineering information systems, HVAC system, medical gas system, steam and hot water generation system, electrical system, plumbing system, safety and security system, building and structural management, preventive maintenance scheduling, utility shutdowns, maintaining documentation, cost management, staffing with the help of latest technologies and adapting to Internet of Things (IoT) for better data collection to do predictive maintenance thereby preventing breakdowns of equipment and assets in a timely manner.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'Advanced Diploma in Healthcare Facilities Management' will be awarded by Edusphere College of Management and Technology Pte Ltd
                            </p>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200 text-gray-900">
                                    {[
                                        { code: "ADHFM01", title: "Overview of Healthcare Facilities Management", hours: 24 },
                                        { code: "ADHFM02", title: "Informatics & Technology in Healthcare", hours: 24 },
                                        { code: "ADHFM03", title: "Advanced M&E System in Healthcare", hours: 24 },
                                        { code: "ADHFM04", title: "Energy Management System", hours: 24 },
                                        { code: "ADHFM05", title: "Internet of Things (IoT) in Healthcare", hours: 24 },
                                        { code: "ADHFM06", title: "Project", hours: 24 },
                                    ].map((module, idx) => (

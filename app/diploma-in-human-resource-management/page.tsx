...
export const metadata: Metadata = {
    ...
    description: "Diploma in HR Management at Edusphere College. 8-month part-time course covering HRM principles, Employment Law, Training & Development. S$600 discount available.",
    keywords: "HR diploma singapore, human resource management course, HR certification singapore, employment law course",
    openGraph: {
        title: "Diploma in Human Resource Management | Edusphere Singapore",
...
export default function DiplomaInHumanResourceManagement() {
    const courseSchema = {
        "@context": "https://schema.org",
        "@type": "Course",
        "name": "Diploma in Human Resource Management",
        "description": "Comprehensive HR management diploma covering principles of HRM, organizational psychology, employment law, and training & development for career advancement in human resources.",
        "provider": {
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Diploma in <span className="text-[#EE4A62]">Human Resource Management</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">HR Expertise</div>
                                        <div className="text-sm text-gray-500">Career development</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-500">Practical skills</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
                            <Image
                                src="/homepage/dhrm1.webp"
                                alt="Diploma in Human Resource Management"
                                fill
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'Diploma in Human Resource Management' will be awarded by Edusphere College of Management and Technology Pte Ltd
                            </p>
                        </div>

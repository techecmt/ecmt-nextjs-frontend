						...
						<div className="overflow-x-auto">
							<table className="w-full">
								...
								<tbody className="divide-y divide-gray-200 text-gray-900">
									{[
										{ code: "DBA01", title: "Principles of Management", hours: 24 },
										{ code: "DBA02", title: "Effective Business Communication", hours: 24 },
										{ code: "DBA03", title: "Principles of Economics", hours: 24 },
										{ code: "DBA04", title: "Principles of Finance & Accounting", hours: 24 },
										{ code: "DBA05", title: "Sales & Marketing", hours: 24 },
										{ code: "DBA06", title: "Human Resource Management", hours: 24 },
									].map((module, idx) => (

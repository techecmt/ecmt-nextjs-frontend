...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		url: "https://edusphere.edu.sg/diploma-in-business-administration",
		siteName: "Edusphere College of Management and Technology",
		locale: "en_SG",
		type: "website",
	},
	alternates: {
		canonical: "https://edusphere.edu.sg/diploma-in-business-administration",
	},
};
...
export default function DiplomaInBusinessAdministration() {
	...
	const courseSchema = {
		...
		"coursePrerequisites": "With minimum 3 GCE 'O' level or International Secondary including English, English language proficiency: GCE 'O' level or equivalent, or matured candidate (i.e. minimum 30 years old with 8 years of working experience) with another relevant certificate qualification",
					...
					<div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
						...
						<div className="space-y-6">
							<div className="flex flex-wrap items-center gap-3">
								...
								<span className="inline-flex items-center px-3 py-1 rounded-full bg-[#EE4A62] text-white text-xs font-semibold">Business Administration</span>
							</div>

							<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
								Diploma in <span className="text-[#EE4A62]">Business Administration</span>
							</h1>

							<p className="text-lg md:text-xl text-gray-600 leading-relaxed">
								Gain multi-disciplinary business acumen and real-world know-how across accounting, economics, management, marketing, and local legislation to meet professional needs or launch your own business.
							</p>
								...
								<div className="flex items-center gap-3">
									<div className="w-12 h-12 bg-[#EE4A62]/10 rounded-lg flex items-center justify-center">
										<svg className="w-6 h-6 text-[#EE4A62]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
											<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7H7m6 0a5 5 0 015 5v4a2 2 0 01-2 2h-1m-8-6h6m-6 0a5 5 0 015 5v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-5a2 2 0 012-2zm6 6H7" />
										</svg>
									</div>
									<div>
										<div className="text-2xl font-bold text-gray-900">Business Core</div>
										<div className="text-sm text-gray-500">Accounting to marketing</div>
									</div>
								</div>
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Practical Focus</div>
										<div className="text-sm text-gray-500">Real-world application</div>
									</div>
								</div>
							</div>
						...
						{/* Right Images (responsive, compact) */}
						<div className="grid gap-3 max-w-md w-full justify-self-end">
							<div className="relative h-48 sm:h-56 md:h-60 lg:h-64 rounded-3xl overflow-hidden shadow-sm">
								<Image
									src="/homepage/dba1.webp"
									alt="Diploma in Business Administration"
									fill
									className="object-cover"
									priority
								/>
							</div>
							<div className="relative h-40 sm:h-48 md:h-52 lg:h-56 rounded-3xl overflow-hidden shadow-sm">
								<Image
									src="/homepage/dba2.webp"
									alt="Diploma in Business Administration"
									fill
									className="object-cover"
									priority
			...
			<section className="py-12 md:py-16 bg-white">
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					...
					<div className="max-w-4xl mx-auto space-y-4 text-gray-700 leading-relaxed text-justify">
						<p>
							The Diploma in Business Administration helps students build multi-disciplinary business acumen and real-world working knowledge. Learn to apply accounting, economics, management, marketing, and local legislation to meet professional demands or start your own business.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<li className="flex items-start gap-3">
                                    ...
                                    <span>Minimum Age Requirement : 21 years old</span>
                                </li>
								<li className="flex items-start gap-3">
									<svg className="w-5 h-5 text-[#EE4A62] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<p className="text-gray-700 text-sm">Blended Learning – (Face to Face & E-learning)</p>
						</div>
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<p className="text-gray-700 text-sm">'Diploma in Business Administration' will be awarded by Edusphere College of Management and Technology Pte Ltd</p>
						</div>
						...
						<div className="overflow-x-auto">
							<table className="w-full">
								...
								<tbody className="divide-y divide-gray-200 text-gray-900">
									{[
										{ code: "DHRM01", title: "Principles of Management", hours: 24 },
										{ code: "DHRM02", title: "Human Resource Management", hours: 24 },
										{ code: "DHRM03", title: "Principles of Economics", hours: 24 },
										{ code: "DHRM04", title: "Principles of Finance & Accounting", hours: 24 },
										{ code: "DHRM05", title: "Sales & Marketing", hours: 24 },
										{ code: "DHRM06", title: "Commercial Law & Contracts", hours: 24 },
									].map((module, idx) => (

...
export default function DiplomaInBusinessAdministrationELearning() {
    ...
    const courseSchema = {
        ...
        "coursePrerequisites": "With minimum 3 GCE 'O' level – C6 or Pass in International Secondary including English, English language proficiency: GCE 'O' level - C6 or equivalent, or matured candidate (i.e. minimum 30 years old with 8 years of working experience) with another relevant certificate qualification",
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Diploma in <span className="text-[#EE4A62]">Business Administration</span><br />
                                <span className="text-[#1AB69D]">(E-Learning)</span>
                            </h1>

                            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                                Diploma in Business Administration is designed to help students gain multi-disciplinary business acumen and real-world working knowledge.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Business Ready</div>
                                        <div className="text-sm text-gray-500">Multi-disciplinary skills</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                        ...
                        <div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
                            <Image
                                src="/homepage/business-admin-elearning.webp"
                                alt="Diploma in Business Administration E-Learning"
                                fill
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
                            DIPLOMA IN BUSINESS ADMINISTRATION (E-LEARNING) is designed to help students gain multi-disciplinary business acumen and real-world working knowledge. Students will learn how to apply their knowledge in key business issues such as accounting, economics, management, marketing and local legislation so that they can better meet the needs and demands of their future profession or can start their own business.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'Diploma in Business Administration (E-Learning)' will be awarded by Edusphere College of Management and Technology Pte Ltd.
                            </p>
                        </div>

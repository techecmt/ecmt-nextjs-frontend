						...
						<div className="bg-white rounded-lg shadow-sm p-6">
							...
							<li className="flex items-start gap-3">
								...
								<li className="flex items-start gap-3">
									...
									<span>Minimum of 3 GCE &apos;O&apos; levels passes including English (C6) or equivalent qualification to GCE &apos;O&apos; Level, such as International Secondary school certificate with passes English</span>
								</li>
								<li className="flex items-start gap-3">
									<svg className="w-5 h-5 text-[#EE4A62] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>

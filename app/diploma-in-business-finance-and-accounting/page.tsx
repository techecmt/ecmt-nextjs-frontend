...
export const metadata: Metadata = {
	title: "Diploma in Business Finance & Accounting | Edusphere Singapore",
	description: "Diploma in Business Finance & Accounting at Edusphere College. 12-month part-time course covering Bookkeeping, Financial Reporting, Payroll Administration, and Accounting Software.",
	keywords: "business finance diploma singapore, accounting course singapore, bookkeeping diploma singapore, payroll administration course, financial management course singapore",
	openGraph: {
		title: "Diploma in Business Finance & Accounting | Edusphere Singapore",
		description: "Part-time Diploma covering Business Accounting, Bookkeeping, Finance & Cost Management, Payroll and Digital Tools. 12 months, 186 hours.",
		url: "https://edusphere.edu.sg/diploma-in-business-finance-and-accounting",
		siteName: "Edusphere College of Management and Technology",
		locale: "en_SG",
		type: "website",
	},
	alternates: {
		canonical: "https://edusphere.edu.sg/diploma-in-business-finance-and-accounting",
	},
};

export default function DiplomaInBusinessFinanceAndAccounting() {
	const courseSchema = {
		"@context": "https://schema.org",
		"@type": "Course",
		"name": "Diploma in Business Finance & Accounting",
		"description": "Diploma equipping learners with practical accounting, bookkeeping, and financial management skills required in modern organisations, covering financial reporting, payroll administration, accounting software, and digital tools.",
		"provider": {
		...
		"teaches": [
			...
			"Practical Bookkeeping & Accounting Operations",
			"Business Finance & Cost Management",
			"Accounting Software Applications",
			"Payroll Administration & Employment Compliance",
			"Excel & Digital Tools for Business Finance"
		],
		"educationalCredentialAwarded": "Diploma in Business Finance & Accounting",
		"timeToComplete": "P12M",
		"totalTime": "PT168H",
		...
		<main className="min-h-screen">
			...
			<section className="relative bg-linear-to-br from-white via-gray-50 to-[#1AB69D]/5 py-16 md:py-24 overflow-hidden">
				<div className="absolute inset-0">
					<Image
						src="/homepage/dbfa-hero.jpg"
						alt="Diploma in Business Finance & Accounting hero image"
						fill
					...
					<div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
						...
						<div className="space-y-6">
							<div className="inline-flex items-center gap-3">
								...
								<span className="animate-pulse inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide bg-[#EE4A62] text-white shadow-lg">
									New
								</span>
							</div>

							<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
								Diploma in <span className="text-[#EE4A62]">Business Finance &amp; Accounting</span>
							</h1>

							<p className="text-lg md:text-xl text-gray-600 leading-relaxed">
								The Diploma in Business Finance &amp; Accounting at Edusphere College equips learners with practical accounting, bookkeeping, and financial management skills required in modern organisations.
							</p>
							...
							<div className="flex flex-wrap gap-6 pt-4">
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Finance-Ready</div>
								...
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<div className="text-sm text-gray-500">Accounting to management pathways</div>
									</div>
								</div>
							</div>
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					...
					<div className="mb-8 space-y-4">
						<p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
							The Diploma in Business Finance &amp; Accounting at Edusphere College of Management and Technology equips learners with practical accounting, bookkeeping, and financial management skills required in modern organisations.
						</p>
						<p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
							The programme focuses on real-world financial operations including bookkeeping, financial reporting, payroll administration, and cost management. Students will also learn to use accounting software and digital tools such as Excel for financial analysis and reporting.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-6 mb-12">
						...
						<p className="text-2xl font-bold text-[#1AB69D]">186 Hours</p>
						</div>
					</div>
				</div>
			</section>
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="bg-white rounded-lg shadow-sm p-6">
							...
							<li className="flex items-start gap-3">
								...
								<li className="flex items-start gap-3">
									...
									<span>Minimum of 3 GCE &apos;O&apos; levels passes including English (C6) or equivalent qualification to GCE &apos;O&apos; Level, such as International Secondary Education certificate with passes English</span>
								</li>
								<li className="flex items-start gap-3">
									<svg className="w-5 h-5 text-[#EE4A62] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
								...
								<li className="flex items-start gap-3">
									...
									<span>Working Experience: Matured candidate:</span>
								</li>
								<li className="flex items-start gap-3 pl-8">
									<svg className="w-4 h-4 text-[#1AB69D] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"/>
									</svg>
									<span>30 years old with 8 years of working experience, or</span>
								</li>
								<li className="flex items-start gap-3 pl-8">
									<svg className="w-4 h-4 text-[#1AB69D] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"/>
									</svg>
									<span>30 years old with 3 years of working experience plus relevant qualifications, to be assessed on a case-by-case basis.</span>
								</li>
							</ul>
						</div>
						...
						<div className="bg-white rounded-lg shadow-sm p-6">
							...
							<p className="text-gray-700 text-sm">
							&apos;Diploma in Business Finance &amp; Accounting&apos; will be awarded by Edusphere College of Management and Technology Pte Ltd
							</p>
						</div>
			...
			<section className="py-12 md:py-16 bg-white">
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					...
					Accountant, Bookkeeper, Accounts Executive, Finance Executive, Payroll Officer, Accounts Assistant, Finance Manager, Cost Accountant, Financial Analyst and more.
					</p>
				</div>
			</section>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-2 text-sm text-gray-700 max-w-xl">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="font-bold text-gray-900">:&nbsp;&nbsp;S$ 2750.00</span>
                </div>
                <div className="flex items-start justify-between gap-4">
                  <span>GST (9%)</span>
                  <span className="font-bold text-gray-900">:&nbsp;&nbsp;S$ 247.50</span>
                </div>

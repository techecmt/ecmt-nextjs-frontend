...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://edusphere.edu.sg/advanced-diploma-in-civil-engineering",
        siteName: "Edusphere College of Management and Technology",
        locale: "en_SG",
        type: "website",
    },
    alternates: {
        canonical: "https://edusphere.edu.sg/advanced-diploma-in-civil-engineering",
    },
};
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                                Advanced Diploma in <span className="text-[#EE4A62]">Civil Engineering</span>
                            </h1>

                            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                                This course will develop a new breed of future-ready human talents who can meet the demand for the growing multi-disciplinary applications in the built environment. They will have sound knowledge in Green Building, and are also adept at the use of technologies for sustainable built environment challenges and solutions.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Future-Ready</div>
                                        <div className="text-sm text-gray-500">Multi-disciplinary skillsets</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-2xl font-bold text-gray-900">Green Building</div>
                                        <div className="text-sm text-gray-500">Sustainable solutions</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
                            <Image
                                src="/homepage/adce.webp"
                                alt="Advanced Diploma in Civil Engineering"
                                fill
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
                            This course will develop a new breed of future-ready human talents who can meet the demand for the growing multi-disciplinary applications in the built environment. They will have sound knowledge in Green Building, and are also adept at the use of technologies for sustainable built environment challenges and solutions. Our students will be equipped with multi-disciplinary skillsets to meet the manpower needs in areas including construction, Project Management, Façade Engineering, smart building, Green Building and Sustainability.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4 md:px-8 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                            ...
                            <p className="text-gray-700 text-sm">
                                'Advanced Diploma in Civil Engineering' will be awarded by Edusphere College of Management and Technology Pte Ltd
                            </p>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200 text-gray-900">
                                    {[
                                        { code: "ADCE01", title: "Construction Materials and Testing", hours: 24 },
                                        { code: "ADCE02", title: "Advanced Foundation Engineering", hours: 24 },
                                        { code: "ADCE03", title: "Project management in Planning & Scheduling", hours: 24 },
                                        { code: "ADCE04", title: "Building Management System", hours: 24 },
                                        { code: "ADCE05", title: "Facade Engineering", hours: 24 },
                                        { code: "ADCE06", title: "Green Building & Sustainability", hours: 24 },
                                    ].map((module, idx) => (

        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start mb-14">
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-4 flex items-center gap-2.5">
              <a aria-label="facebook" className="h-10 px-3.5 rounded-full border border-gray-300 bg-white hover:bg-gray-100 inline-flex items-center gap-2 text-[#4267B2] transition-colors" href="#"><FaFacebookF /><span className="hidden sm:inline text-xs font-medium text-gray-700">Facebook</span></a>
              <a aria-label="instagram" className="h-10 px-3.5 rounded-full border border-gray-300 bg-white hover:bg-gray-100 inline-flex items-center gap-2 text-pink-600 transition-colors" href="#"><FaInstagram /><span className="hidden sm:inline text-xs font-medium text-gray-700">Instagram</span></a>
              <a aria-label="tiktok" className="h-10 px-3.5 rounded-full border border-gray-300 bg-white hover:bg-gray-100 inline-flex items-center gap-2 text-gray-900 transition-colors" href="#"><SiTiktok /><span className="hidden sm:inline text-xs font-medium text-gray-700">TikTok</span></a>
              <a aria-label="linkedin" className="h-10 px-3.5 rounded-full border border-gray-300 bg-white hover:bg-gray-100 inline-flex items-center gap-2 text-sky-700 transition-colors" href="#"><FaLinkedinIn /><span className="hidden sm:inline text-xs font-medium text-gray-700">LinkedIn</span></a>
              <a aria-label="youtube" className="h-10 px-3.5 rounded-full border border-gray-300 bg-white hover:bg-gray-100 inline-flex items-center gap-2 text-red-600 transition-colors" href="#"><FaYoutube /><span className="hidden sm:inline text-xs font-medium text-gray-700">YouTube</span></a>
            </div>
          </div>

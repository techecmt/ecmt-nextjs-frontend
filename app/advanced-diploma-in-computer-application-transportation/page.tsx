...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://edusphere.edu.sg/advanced-diploma-in-computer-application-transportation",
        siteName: "Edusphere College of Management and Technology",
        locale: "en_SG",
        type: "website",
    },
    alternates: {
        canonical: "https://edusphere.edu.sg/advanced-diploma-in-computer-application-transportation",
    },
};
				...
				<div className="container mx-auto px-4 md:px-8 relative z-10">
					<div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
						...
						<div className="space-y-6">
							<div className="flex flex-wrap items-center gap-3">
								<span className="inline-flex items-center gap-2 px-4 py-2 bg-[#1AB69D]/10 text-[#1AB69D] rounded-full text-sm font-semibold">
									...
									Smart Transportation Programme
								</span>
								
							</div>

							<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
								Advanced Diploma in <span className="text-[#EE4A62]">Computer Application (Transportation)</span>
							</h1>

							<p className="text-lg md:text-xl text-gray-600 leading-relaxed">
								Master the technologies behind smart road infrastructure maintenance, from tunnel systems and energy management to data analytics and IoT-driven predictive maintenance.
							</p>
							...
							<div className="flex flex-wrap gap-6 pt-4">
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Smart Systems</div>
										<div className="text-sm text-gray-500">Tunnel, energy, safety</div>
									</div>
								</div>
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Blended Learning</div>
						...
						<div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
							<Image
								src="/homepage/adca.webp"
								alt="Advanced Diploma in Computer Application (Transportation)"
								fill
			...
			<section className="py-12 md:py-16 bg-white">
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					...
					<div className="max-w-4xl mx-auto space-y-4 text-gray-700 leading-relaxed text-justify">
						<p>
							This programme equips learners with the technologies used in smart maintenance of road infrastructure. Explore smart tunnel management, energy management, data communication and networking, analytics to build complex data models, IoT for predictive maintenance, and strategic technology adoption in transportation.
						</p>
						<p>
							You will examine integrated systems that keep transport networks safe and efficient, including smart lighting, ventilation, flood controls, surveillance, electrical installations, sensors, telephony, communication channels, fire systems, and traffic management.
						</p>
					</div>
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<ul className="space-y-3 text-gray-700 text-sm">
								<li className="flex items-start gap-3">
									...
									<span>Minimum 3 GCE 'A' level or International Secondary including English</span>
								</li>
								<li className="flex items-start gap-3">
									<svg className="w-5 h-5 text-[#EE4A62] mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<p className="text-gray-700 text-sm">'Advanced Diploma in Computer Application (Transportation)' will be awarded by Edusphere College of Management and Technology Pte Ltd</p>
						</div>
						...
						<div className="overflow-x-auto">
							<table className="w-full">
								...
								<tbody className="divide-y divide-gray-200 text-gray-900">
									{[
										{ code: "ADCA01", title: "Smart Tunnel Management (M&E)", hours: 24 },
										{ code: "ADCA02", title: "Energy Management System", hours: 24 },
										{ code: "ADCA03", title: "Data Communication & Networking", hours: 24 },
										{ code: "ADCA04", title: "Data Analytics", hours: 24 },
										{ code: "ADCA05", title: "Internet of Things (IoT) in Transportation", hours: 24 },
										{ code: "ADCA06", title: "Project", hours: 24 },
									].map((module, idx) => (

...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://edusphere.edu.sg/advanced-diploma-in-engineering-coordinator",
	},
};

export default function AdvancedDiplomaInEngineeringCoordinator() {
	const courseSchema = {
							...
							<div className="flex flex-wrap gap-6 pt-4">
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<div className="text-sm text-gray-500">Practical, engineering-focused skills</div>
									</div>
								</div>
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<div className="text-sm text-gray-500">Operations to coordination pathways</div>
									</div>
								</div>
							</div>
						...
						<div className="bg-white rounded-lg shadow-sm p-6">
							...
							<li className="flex items-start gap-3">
								...
								<li className="flex items-start gap-3 pl-8">
									...
									<span>30 years old with 3 years of relevant working experience plus relevant qualifications, to be assessed on a case-by-case basis.</span>
								</li>
							</ul>
						</div>
						...
						<div className="overflow-x-auto">
							<table className="w-full">
								...
								<tbody className="divide-y divide-gray-200 text-gray-900">
									{[
										{ code: "ADEC01", title: "Engineering Coordination & Project Management", hours: 31 },
										{ code: "ADEC02", title: "Air-conditioning & Mechanical Ventilation", hours: 31 },
										{ code: "ADEC03", title: "Water, Sanitary & Gas Services", hours: 31 },
										{ code: "ADEC04", title: "Building Electrical Systems & Design", hours: 31 },
										{ code: "ADEC05", title: "Fire Safety Management", hours: 31 },
										{ code: "ADEC06", title: "Intelligent & Green Buildings", hours: 31 },
									].map((module, idx) => (

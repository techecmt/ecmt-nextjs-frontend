					...
					<div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
						...
						<div className="space-y-6">
							...
							<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
								Diploma in <span className="text-[#EE4A62]">Hotel and Tourism Management</span>
							</h1>

							<p className="text-lg md:text-xl text-gray-600 leading-relaxed">
								For those who love meeting people from around the world and want to enter the dynamic tourism and hospitality sector. Start your journey into hotel and tourism leadership.
							</p>
							...
							<div className="flex flex-wrap gap-6 pt-4">
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Hospitality Focus</div>
										<div className="text-sm text-gray-500">Rooms, F&B, tourism</div>
									</div>
								</div>
								<div className="flex items-center gap-3">
									...
									<div>
										<div className="text-2xl font-bold text-gray-900">Face-to-Face</div>
										<div className="text-sm text-gray-500">Classroom & practical</div>
									</div>
								</div>
							</div>
							...
							<div className="rounded-xl border border-dashed border-gray-300 bg-white/70 p-4 text-sm text-gray-700">
								<p className="font-semibold text-gray-900">New Update:</p>
								<p>Old Course Title: “Diploma in Hospitality Management” has been changed to “Diploma in Hotel and Tourism Management” with effect from 16 October 2025. For clarification, please contact +65 9125 4523.</p>
							</div>
						</div>
						...
						<div className="relative h-[450px] md:h-[550px] rounded-tl-3xl rounded-br-3xl overflow-hidden">
							<Image
								src="/homepage/diphospital.webp"
								alt="Diploma in Hotel and Tourism Management"
								fill
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					...
					<div className="mb-8">
						<p className="text-gray-900 leading-relaxed text-justify max-w-4xl mx-auto">
							This diploma opens doors worldwide, grooming future leaders for hospitality and tourism. Become adaptable and resourceful across core business subjects and specialised areas like Room Division Management, F&B Services, and Waste Management for Hotels and Restaurants, plus entrepreneurial skills to launch your career or business.
						</p>
					</div>
				...
				<div className="container mx-auto px-4 md:px-8 max-w-6xl">
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
							...
							<p className="text-gray-700 text-sm">'Diploma in Hotel and Tourism Management' will be awarded by Edusphere College of Management and Technology Pte Ltd.</p>
						</div>
						...
						<div className="overflow-x-auto">
							<table className="w-full">
								...
								<tbody className="divide-y divide-gray-200 text-gray-900">
									{[
										{ code: "DHM - CRM", title: "Customer Relationship Management", hours: 24 },
										{ code: "DHM - RDM", title: "Room Division Management", hours: 24 },
										{ code: "DHM - F&B", title: "Food and Beverage Management", hours: 24 },
										{ code: "DHM - EBC", title: "Effective Business Communication", hours: 24 },
										{ code: "DHM - EH", title: "Entrepreneurship in Hospitality", hours: 24 },
										{ code: "DHM - WMHR", title: "Waste Management for Hotels and Restaurants", hours: 24 },
									].map((module, idx) => (

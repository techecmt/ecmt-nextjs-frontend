						...
						<div className="overflow-x-auto">
							<table className="w-full">
								...
								<tbody className="divide-y divide-gray-200 text-gray-900">
									{[
										{ code: "DHTM01", title: "Customer Relationship Management", hours: 24 },
										{ code: "DHTM02", title: "Room Division Management", hours: 24 },
										{ code: "DHTM03", title: "Food and Beverage Management", hours: 24 },
										{ code: "DHTM04", title: "Effective Business Communication", hours: 24 },
										{ code: "DHTM05", title: "Entrepreneurship in Hospitality", hours: 24 },
										{ code: "DHTM06", title: "Waste Management for Hotels and Restaurants", hours: 24 },
									].map((module, idx) => (

...
export default function DiplomaInCaregiving() {
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-white via-gray-50 to-[#1AB69D]/5 py-16 md:py-24 overflow-hidden">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <ul className="space-y-3 text-gray-700 text-sm">
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#EE4A62] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#EE4A62] text-white flex items-center justify-center flex-shrink-0 font-bold">
                    1
                  </div>

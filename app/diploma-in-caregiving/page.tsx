...
export const metadata: Metadata = {
  title: "Diploma in Caregiving | Edusphere Singapore",
  description: "Diploma in Caregiving at Edusphere College. 8-month part-time course covering Healthcare, Infant Care, Elderly Care, Fall Prevention. S$600 discount available.",
  keywords: "caregiving diploma singapore, caregiver course singapore, elderly care course, infant care certification singapore",
  openGraph: {
    title: "Diploma in Caregiving | Edusphere Singapore",
    description: "Part-time caregiving diploma covering Healthcare, Newborn Care, Ageing Process & Fall Prevention. 8 months, S$600 discount.",
    url: "https://www.edusphere.edu.sg/diploma-in-caregiving",
    siteName: "Edusphere College of Management and Technology",
    locale: "en_SG",
    type: "website",
  },
  alternates: {
    canonical: "https://www.edusphere.edu.sg/diploma-in-caregiving",
  },
};
...
export default function DiplomaInCaregiving() {
  const courseSchema = {
    ...
    "description": "Comprehensive caregiving diploma covering healthcare fundamentals, newborn and infant care, ageing process, physical health promotion, and fall prevention management.",
    "provider": {
    ...
    "teaches": [
      "Introduction to health care & role of Caregiver",
    ...
    "educationalCredentialAwarded": "Diploma in Caregiving",
    "timeToComplete": "P8M",
    "totalTime": "PT144H",
